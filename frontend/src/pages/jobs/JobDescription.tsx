        ...
        <section className="max-w-7xl mx-auto my-10 font-inter">
            <div className="max-w-md mx-auto px-5 md:px-0">
                ...
                <div className="flex flex-col md:flex-row  gap-3 md:gap-10 items-start md:items-center  mt-5 ">
                    <div className={'font-semibold flex text-[#4CAF50]'} >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6 mr-2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                        </svg>
                        <p>12 Position</p>
                    </div>
                    <div className={' font-semibold flex text-[#FF6500]'} >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6 mr-2">
                ...
                <div className="w-full md:w-[500px] mt-5">
                    ...
                    <h3 className="font-semibold my-2">Role:</h3>
                    ...
                    <h3 className="font-semibold my-2">Posted Date:</h3>
                </div>
                <Button
                disabled={isApplied}
